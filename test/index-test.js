...
describe('InFrontOfYou', () => {
  ...
  it('should have the right DOM markup', () => {
    expect(wrapper.html()).to.equal(`<div><p>You should not look too far.</p><p>Sometimes, the solution is right in front of you.</p></div>`);
  });
});
...
describe('App', () => {
  ...
  it('should contain the InFrontOfYou component', () => {
    expect(wrapper.html()).to.include(`<div><p>You should not look too far.</p><p>Sometimes, the solution is right in front of you.</p></div>`)
  });
